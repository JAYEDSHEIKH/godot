...
// Fix 13 — never create here; ownership belongs to register_types.cpp
...
void ConfigManager::_bind_methods() {
    ...
    ADD_SIGNAL(MethodInfo("profile_loaded",
...
void ConfigManager::set(const String &key, const Variant &value) {
    config[key] = value;
